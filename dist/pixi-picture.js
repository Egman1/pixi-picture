...
(function (pixi_picture) {
    ...
    (function (blends) {
        ...
        (function (CUSTOM_BLEND_MODES) {
            CUSTOM_BLEND_MODES[CUSTOM_BLEND_MODES["MULTIPLY"] = 5] = "MULTIPLY";
        ...
        blends.MULTIPLY_FULL = blends.NPM_BLEND.replace("%NPM_BLEND%", blends.MULTIPLY_PART);
